...
for t = 1:stage
    ...
    l_min{t} = calcGradientExp(active{t},neib1{t},voronoi_rg{t},pos,p2,size(pos,1),coef);   % l_min: local minimizer
    [cst(t),~] = calcCostExp(neib2{t},voronoi_rg{t},pos,p2,coef,n1,adv,type);
    idx{t} = find(active{t});
    if type == 2 || type == 3
